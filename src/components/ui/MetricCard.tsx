...
export const MetricCard: React.FC<MetricCardProps> = ({ 
  ...
  return (
    <motion.div 
      ...
      className="bg-bg-surface dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-[32px] p-8 flex flex-col gap-4 shadow-[0_10px_30px_-10px_rgba(0,0,0,0.1)] hover:shadow-[0_25px_60px_-15px_rgba(0,82,255,0.15)] transition-all cursor-default perspective-1000"
    >
